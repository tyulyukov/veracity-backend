...
export class UpdateEventDto {
  @ApiPropertyOptional({ example: 'Tech Talk: Cloud Architecture' })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  name?: string;

  @ApiPropertyOptional({ example: true, description: 'Whether the event is online or offline' })
  @IsOptional()
  @IsBoolean()
  isOnline?: boolean;

  @ApiPropertyOptional({ example: '2026-02-15T18:00:00Z' })
  @IsOptional()
  @IsDateString()
  eventDate?: string;
